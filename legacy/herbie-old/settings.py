"""
Django settings for herbie_core project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'herbie_core/../../herbie_core/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'herbie_core.wsgi.application'
...
KAFKA = {
    'SERVERS': 'herbie_core-kafka:9093',
    'TIMEOUT': 30000
}
