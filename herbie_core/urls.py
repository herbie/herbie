...
from herbie_core.views.get_business_entity_data_view import GetBusinessEntityData
...
urlpatterns = [
    ...
    path("business-entity/<str:business_entity>/<str:key>", GetBusinessEntityData().as_view(), {"version": None}),
    path("business-entity/<str:business_entity>/<str:key>/<str:version>", GetBusinessEntityData().as_view()),
]
